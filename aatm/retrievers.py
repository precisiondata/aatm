...
CHROMADB_RETRIEVER_MODEL_REGISTRY = {
    "qwen3-06B": {
        ...
        "chromadb_path": ".aatm/chroma_vector_dbs/qwen3-06B",
    ...
    "qwen3-4B": {
        ...
        "embedding_function": Qwen3EmbeddingFunction,
        "collection_name": "expressions",
        "chromadb_path": ".aatm/chroma_vector_dbs/qwen3-4B",
    ...
    "gemini-embedding-001": {
        ...
        "collection_name": "expressions",
        "chromadb_path": ".aatm/chroma_vector_dbs/gemini-embedding-001",
    ...
    "embeddinggemma-300M": {
        ...
        "collection_name": "expressions",
        "chromadb_path": ".aatm/chroma_vector_dbs/embeddinggemma-300M",
    ...
    "text-embedding-3-small": {
        ...
        "collection_name": "expressions",
        "chromadb_path": ".aatm/chroma_vector_dbs/text-embedding-3-small",
    ...
    "text-embedding-3-large": {
        ...
        "embedding_function": OpenAIEmbeddingFunction,
        "collection_name": "expressions",
        "chromadb_path": ".aatm/chroma_vector_dbs/text-embedding-3-large",
